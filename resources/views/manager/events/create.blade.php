                    ...
                    <form method="POST" action="{{ route('events.store') }}">
                        ...
                        <div class="md:flex justify-between">
                            <div class="mt-4">
                                ...
                                <x-jet-input id="event_date" class="block mt-1 w-full" type="type" name="event_date" required />
                            </div>
                            <div class="mt-4">
                                <x-jet-label for="start_time" value="開始時間" />
                                <x-jet-input id="start_time" class="block mt-1 w-full" type="type" name="start_time" required />
                            </div>
                            <div class="mt-4">
                                <x-jet-label for="end_time" value="終了時間" />
                                <x-jet-input id="end_time" class="block mt-1 w-full" type="type" name="end_time" required />
                            </div>
                        </div>
